...
/////////////////////////////////////////////////////////////////
// StarCell: Holds the basic information for a cell to be used
// with A* search routing algorithm
/////////////////////////////////////////////////////////////////
struct StarCell
{
	int x;
...
/////////////////////////////////////////////////////////////////
// DropletPoint: Holds the basic information for droplet route point
// to be used with A* search routing algorithm
/////////////////////////////////////////////////////////////////
struct DropletPoint
{
	int x;
	int y;
	int g_score;
	vector<StarCell *> camefrom;
	Droplet *droplet;
};

/////////////////////////////////////////////////////////////////
// PrStarCell: Holds the basic information for a cell to be used
// with prioritized A* search routing algorithm
/////////////////////////////////////////////////////////////////
struct PrStarCell
{
	int x;
	...
	bool block;
	bool isUsed;
	PrStarCell* came_from;
};

/////////////////////////////////////////////////////////////////
// StarRoutePoint: Holds the basic information for droplet route point
// to be used with A* search compaction algorithm
/////////////////////////////////////////////////////////////////
struct StarRoutePoint
{
	int rpindex;
	RoutePoint *rp;
	bool isStalled;
...
/////////////////////////////////////////////////////////////////
// OpenSetNode: Holds the basic information for routing state
// to be used with A* search compaction algorithm
/////////////////////////////////////////////////////////////////
struct OpenSetNode
{
	vector<vector<StarRoutePoint> > cell;
	int h_score;
};
