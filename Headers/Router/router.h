...
class Router
{
	...
	protected:
		...
		void compactRoutesWithAStarCompactor(vector<vector<RoutePoint *> *> *subRoutes);
		void compactRoutesWithPrioritizedAStarCompactor(vector<vector<RoutePoint *> *> *subRoutes);
