...
int main(int argc, char **argv)
{
	...
	else // Hard-coded Sandbox
	{
		...
		////////////////////////////////////////////////////////////////////////////
		//Synthesis::EntireFlow("Assays/B1/Dilute/PCRDilute.txt", "DmfbArchs/IndividuallyAddressable/B1/Arch_16_16_B1.txt", LIST_S, GRISSOM_LE_B, PR_A_STAR_TYPE_1B_R, GRISSOM_FIX_1_RA, INDIVADDR_PM, NONE_WR, BEG_COMP, FIXED_PE, ALL_EX, maxDropsPerStorageMod, minCellsBetweenIrMods, 3, 3);
		////////////////////////////////////////////////////////////////////////////
		...
		//Synthesis::WireRoute("Output/3_ROUTE_to_SIM.txt", FPPC2_WR, 3, 3);
		////////////////////////////////////////////////////////////////////////////
		...
		Synthesis::Schedule("Assays/Testing/Single_3_Input_Mix.txt", "DmfbArchs/IndividuallyAddressable/Testing/Arch_8_7_Simple.txt", "Output/1_SCHED_to_PLACE.txt", LIST_S, GRISSOM_FIX_0_RA, INDIVADDR_PM, maxDropsPerStorageMod); // Good for debugging pin-assignment and wire-routing
		...
		///////////////////////////     A* ROUTER    ///////////////////////////////
		////////////////////////////////////////////////////////////////////////////
        Synthesis::Route("Output/2_PLACE_to_ROUTE.txt", PR_A_STAR_TYPE_1X_R, false, INHERENT_COMP , FIXED_PE, SIM_EX);
        ////////////////////////////////////////////////////////////////////////////
