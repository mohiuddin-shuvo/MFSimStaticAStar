...
Router * Synthesis::getNewRoutingMethod(RouterType rt, DmfbArch *arch)
{
	...
	else if (rt == A_STAR_TYPE_1_R || rt == A_STAR_TYPE_2_R || rt == A_STAR_TYPE_3_R)
		return new AStarRouter(arch);
	else if (rt == PR_A_STAR_TYPE_1S_R || rt == PR_A_STAR_TYPE_2S_R || rt == PR_A_STAR_TYPE_3S_R ||
			rt == PR_A_STAR_TYPE_1L_R || rt == PR_A_STAR_TYPE_2L_R || rt == PR_A_STAR_TYPE_3L_R ||
			rt == PR_A_STAR_TYPE_1R_R || rt == PR_A_STAR_TYPE_2R_R || rt == PR_A_STAR_TYPE_3R_R ||
			rt == PR_A_STAR_TYPE_1X_R || rt == PR_A_STAR_TYPE_2X_R || rt == PR_A_STAR_TYPE_3X_R ||
			rt == PR_A_STAR_TYPE_1Y_R || rt == PR_A_STAR_TYPE_2Y_R || rt == PR_A_STAR_TYPE_3Y_R ||
			rt == PR_A_STAR_TYPE_1B_R || rt == PR_A_STAR_TYPE_2B_R || rt == PR_A_STAR_TYPE_3B_R)
		return new PrioritizedAStarRouter(arch);
	else if (rt == LEE_R)
